...
export default function AssistantChat({ mode = "student" }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="relative w-[360px] max-w-[92vw] h-[520px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          ...
          <div className="px-4 pt-3">
            <div className="inline-flex max-w-full items-start gap-2 rounded-2xl border border-green-100 bg-green-50 px-3 py-2 text-xs text-green-900 shadow-sm">
              <span className="mt-0.5 inline-flex h-2 w-2 flex-none rounded-full bg-green-500" />
              <span className="leading-relaxed">
                Hi, I&apos;m your assistant. Ask me about routes, timings, bus booking, or anything else you need.
              </span>
            </div>
          </div>
