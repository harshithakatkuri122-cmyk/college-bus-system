    ...
    <main className={`px-20 py-12 transition-opacity duration-400 ease-out ${mounted ? "opacity-100" : "opacity-0"}`}>
      <div className="max-w-4xl mx-auto">
          ...
          <ol className="space-y-4 list-decimal list-inside text-gray-700">
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div>
                  <button onClick={() => navigate('/login')} className="group relative bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-3 rounded-lg shadow-md hover:shadow-2xl transition-all duration-300 font-bold">
                    Click Here to Login
                  </button>
                </div>
              </div>
        ...
        <div className="mt-8 flex justify-between">
          ...
          <button onClick={() => navigate('/login')} className="px-6 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700">Login</button>
        </div>
      </div>
    </main>
  );
